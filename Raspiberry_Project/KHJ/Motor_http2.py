...
state_dict={"Forward":[0.5,0.5,0,0,1,0],
            ...
            "RightTurn":[0,0.5,0,0,0,0],
            "LeftTurn":[0.5,0,0,0,0,0],
            "Stop":[0,0,0,0,0,0]
            }
...
def Move(status):#,fr,fl,rer,rel,Fo,Bw): 
    ...
    print(status)
    forwardRight.value=fr+(Fo*0.25*num)
    reverseRight.value=rer+(Bw*0.25*num)
    forwardLeft.value=fl+(Fo*0.25*num)
    reverseLeft.value=rel+(Bw*0.25*num)
    time.sleep(1)
